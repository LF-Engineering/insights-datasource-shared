  ...
  container_definitions = jsonencode([
    {
      ...
      image     = "395594542180.dkr.ecr.us-east-1.amazonaws.com/insights-connector-git:test"
      cpu       = 128
      memory    = 512
      essential = true
      logConfiguration: {
        "logDriver": "awslogs",
        "options": {
          "awslogs-group": "insights-connector-git-task",
  ...
  container_definitions = jsonencode([
    {
      ...
      image     = "395594542180.dkr.ecr.us-east-1.amazonaws.com/insights-connector-jira:test"
      cpu       = 128
      memory    = 512
      essential = true
      logConfiguration: {
