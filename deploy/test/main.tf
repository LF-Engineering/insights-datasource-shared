  ...
  container_definitions = jsonencode([
    {
      ...
      image     = "726224182707.dkr.ecr.${var.eg_aws_region}.amazonaws.com/insights-connector-jenkins:test"
      cpu       = 128
      memory    = 512
      essential = true
      logConfiguration: {
  ...
  container_definitions = jsonencode([
    {
      ...
      image     = "726224182707.dkr.ecr.${var.eg_aws_region}.amazonaws.com/insights-connector-circleci:test"
      cpu       = 128
      memory    = 512
      essential = true
      logConfiguration: {
  ...
  container_definitions = jsonencode([
    {
      ...
      image     = "726224182707.dkr.ecr.${var.eg_aws_region}.amazonaws.com/insights-connector-rocketchat:test"
      cpu       = 128
      memory    = 512
      essential = true
      logConfiguration: {
  ...
  container_definitions = jsonencode([
    {
      ...
      image     = "726224182707.dkr.ecr.${var.eg_aws_region}.amazonaws.com/insights-connector-confluence:test"
      cpu       = 128
      memory    = 512
      essential = true
      logConfiguration: {
